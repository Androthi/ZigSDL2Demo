// from a Fabio Arnold article on DEV.
// build with zig version 0.9.0-dev.463+3e8394776
...
pub fn main() anyerror!void {
   ...
   var window = c.SDL_CreateWindow("Zig SDL Demo",
    ...
    mainloop: while(true) {
        ...
        var rect = c.SDL_Rect{ .x = 0, .y = 0,
                                .w = 60, .h = 60
        };
        const a = 0.006 * @intToFloat(f32, frame);
